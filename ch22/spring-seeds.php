...
<html>
  <head>
    ...
    <meta charset=utf-8>
    <meta name="description"  content="Bulbs,crocuses, snowdrops, daffodils forv the spring garden">
    <meta name="keywords" content="Spring bulbs, seeds, spring garden bulbs">
...
<div id="leftcol">
      <?php include ("vertnav.html"); ?>
        ...
        <div id="midcol">
          ...
          <div id="midcol-left">
            <p class="left">View and order spring bulbs using this website, or visit the Spring Garden Centre at 10 The Street, Townsville.</p><br>
